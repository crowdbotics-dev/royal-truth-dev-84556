"""
Django settings for royal_truth_dev_84556 project.
...
ROOT_URLCONF = 'royal_truth_dev_84556.urls'
...
WSGI_APPLICATION = 'royal_truth_dev_84556.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "royal_truth_dev_84556 API",
    "DESCRIPTION": "API documentation for royal_truth_dev_84556 App",
    "VERSION": "v1",
}
